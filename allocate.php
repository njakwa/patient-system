...
function allocate(){
    ...
    if (isset($_POST["register"])) {
        ...
        $patient = htmlentities(mysqli_real_escape_string($conn, $_POST['patient']));
        $device = htmlentities(mysqli_real_escape_string($conn, $_POST['device']));
    
    
        if (empty($patient) || empty($device)) {
        ...
        if ($check) {
            ...
            $edit = "UPDATE devices SET status = 'assigned' WHERE device_id = '$device'"; 
                ...
                if ($run) {
                    ...
                    if ($sql_insert) {
                        ...
                        $message = 'Patient Successfully Allocated';
            ...
            $message = "The DEVICE is already Allocated"; 
        }
...
.chart-area .textbox{
    ...
    font-size: 20px;
    padding: 3px 0;
    border-bottom: 1px solid hsl(180, 2%, 39%);
    /* margin: 8px 0; */
}

.chart-area .textbox label{
    /* float: left; */
    text-align: center;
}

.chart-area .textbox input{
    border: none;
    background: none;
    outline: none;
    color: black;
...
.chart-area .btn{
    background-color: rgb(86, 89, 250);
    color: black;
}

.chart-area .btn:hover{
...
.chart-area .radio label{
    float: left;
    text-align: center;
}

.chart-area .radio span{
    float: left;
    text-align: center;
    padding-left: 5%;
}

.chart-area .radio input{
    color: black;
    width: auto;
    float: left;
    margin: 0 10px;
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Allocate Patients</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <form action="allocate.php" method="POST">
                                                ...
                                                <select name="patient" id="input">
                                                    <?php
                                                        ...
                                                        while ($row = $run->fetch_assoc()) {?>
                                                            <option value="<?php echo $row['patient_id']; ?>"> <?php echo $row['first_name'].$row['last_name'] ; ?></option>
                                                        <?php
                                                        }
                                            ...
                                            <div class="textbox">
                                                <label for="">Device Name</label> <br>
                                                <select name="device" id="input">
                                                    <?php
                                            ...
                                            <div>
                                                <input type="submit" name="register" class="btn" value="Allocate Patient" >
                                            </div>
